        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            {topTracks.map((track, index) => {
              const coverImage = albumImages[track.albumId]?.image;
              return (
                <motion.a
                  key={track.title}
                  ...
                  rel="noopener noreferrer"
                  variants={itemVariants}
                  className="flex items-center gap-4 bg-white rounded-xl overflow-hidden shadow-sm hover:shadow-md transition-all border border-gray-100 group"
                >
                  {/* Cover Art */}
                  <div className="relative w-16 h-16 flex-shrink-0">
                    {coverImage ? (
                      ...
                      <div className="w-full h-full bg-gradient-to-br from-[#2E86DE] to-[#1A1A2E]" />
                    )}
                  </div>
                  ...
                  <div className="text-right flex-shrink-0 pr-4 flex items-center gap-3">
                    <div>
                      <p className="font-bold text-[#1A1A2E]">{track.streams}</p>
                      <p className="text-xs text-gray-400">streams</p>
                    </div>
                    <svg className="w-5 h-5 text-[#1DB954] opacity-0 group-hover:opacity-100 transition-opacity" viewBox="0 0 24 24" fill="currentColor">
