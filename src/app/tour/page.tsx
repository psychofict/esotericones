...
export default function TourPage() {
  return (
    <main className="min-h-screen bg-white text-[#1A1A2E] flex items-center justify-center relative overflow-hidden">
      <div className="absolute top-16 left-[10%] w-36 h-36 rounded-full bg-[#2E86DE]/8 blur-2xl" />
      <div className="absolute bottom-20 right-[12%] w-44 h-44 rounded-full bg-[#F39C12]/8 blur-2xl" />
      ...
      >
        ...
        >
          Live shows and tour dates are coming soon.
          Follow along for announcements on upcoming performances.
        </motion.p>
