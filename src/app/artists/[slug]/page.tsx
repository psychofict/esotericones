      ...
      <section className="pt-32 pb-16 px-6">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="flex flex-col md:flex-row gap-8 items-start">
            {/* Artist avatar */}
            <motion.div
              className="w-32 h-32 md:w-40 md:h-40 rounded-full bg-gradient-to-br from-[#E8385D]/20 to-[#FF4D73]/10 flex items-center justify-center flex-shrink-0"
                ...
                >
                  {artist.socials.map((social) => (
                    <a
                      ...
                      className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 text-sm text-white/70 hover:text-[#E8385D] hover:bg-[#E8385D]/10 transition-colors"
                    >
                ...
                {artistReleases.map((release) => (
                  <motion.div key={release.slug} variants={fadeUp}>
                    <Link
                      ...
                      className="group flex items-center gap-4 glass-card rounded-xl p-4 card-hover"
                    >
                      <div className="w-14 h-14 rounded-lg bg-gradient-to-br from-[#E8385D]/20 to-[#FF4D73]/10 flex items-center justify-center flex-shrink-0">
                      ...
                      <div className="min-w-0">
                        ...
                        <p className="text-xs text-[#666666]">
                          {release.year} &middot; {release.type.charAt(0).toUpperCase() + release.type.slice(1)}
                        </p>
                      </div>
                    </Link>
                  </motion.div>
