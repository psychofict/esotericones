  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center relative overflow-hidden">
      ...
      >
        ...
        <motion.h1
          className="text-8xl md:text-9xl font-bold text-foreground mb-6"
        ...
        >
          ...
          <Link
            href="/releases"
            className="inline-block px-8 py-3 border border-border text-foreground rounded-full font-medium hover:bg-subtle/5 transition-colors"
          >
            Browse Releases
          </Link>
        </motion.div>
