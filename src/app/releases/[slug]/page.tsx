      ...
      <section className="pt-32 pb-24 px-6">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            {/* Artwork */}
            <motion.div
              className="aspect-square rounded-2xl bg-gradient-to-br from-[#E8385D]/20 via-[#141414] to-[#FF4D73]/10 flex items-center justify-center"
            ...
            >
              ...
              <motion.div variants={fadeUp} className="flex flex-wrap items-center gap-4 mb-6">
                <span className="flex items-center gap-2 text-sm text-[#A0A0A0]">
              ...
              <motion.div variants={fadeUp} className="flex gap-3 mb-8">
                <a
                  ...
                  className="inline-flex items-center gap-2 px-6 py-3 bg-[#1DB954] text-white rounded-full text-sm font-semibold hover:bg-[#1ed760] transition-colors"
                >
                ...
                <motion.div variants={fadeUp} className="mt-8">
                  ...
                  <div className="space-y-2">
                    {release.tracklist.map((track) => (
                      <div
                        key={track.number}
                        className="flex items-center gap-4 py-2.5 px-4 rounded-lg hover:bg-white/5 transition-colors"
                      >
                        <span className="text-sm text-[#666666] w-6 text-right">
                          {track.number}
                        </span>
                        <Music size={14} className="text-[#E8385D]" />
