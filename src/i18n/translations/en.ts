...
export const en: TranslationKeys = {
  ...
  // Artist detail
  "artist.backToArtists": "Back to Artists",
  "artist.joined": "Joined",
  "artist.listen": "Listen",
  "artist.discography": "Discography",
  "artist.relatedArtists": "Related Label Artists",
  ...
  // Release detail
  "release.backToReleases": "Back to Releases",
  ...
  "contact.licensing": "Licensing & Sync",
  ...
  "demos.country": "Country",
  "demos.countryPlaceholder": "Your country",
  "demos.genre": "Genre",
  "demos.selectGenre": "Select genre",
  "demos.demoLinks":
    "Demo Link(s) \u2014 Spotify, SoundCloud, Google Drive, etc.",
  "demos.socialLinks": "Social Links \u2014 Instagram, Spotify, etc.",
  "demos.socialLinksPlaceholder": "https://instagram.com/yourname",
  "demos.shortBio": "Short Bio / Message",
  "demos.bioPlaceholder": "Tell us about yourself and your music...",
  "demos.submitting": "Submitting...",
  "demos.submitDemo": "Submit Demo",
  "demos.successMessage":
    "Demo submitted! We'll review it and get back to you.",
