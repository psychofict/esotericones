export const label = {
  ...
  location: "South Africa, Zimbabwe & South Korea",
  email: "contact@esotericones.com",
  website: "https://esotericones.com",
  spotifyUrl: "https://open.spotify.com/artist/4mH71Zjiq36Q3SI7IZIBQK",
};
...
export const labelSocials = [
  { name: "Spotify", url: "https://open.spotify.com/artist/4mH71Zjiq36Q3SI7IZIBQK", icon: "spotify" },
  { name: "Instagram", url: "https://instagram.com/esotericones_", icon: "instagram" },
  { name: "Twitter/X", url: "https://twitter.com/esotericones", icon: "twitter" },
  { name: "SoundCloud", url: "https://soundcloud.com/esotericones", icon: "soundcloud" },
  { name: "YouTube", url: "https://youtube.com/@esotericones", icon: "youtube" },
];
